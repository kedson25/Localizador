...
export type ProfileRow = { firebase_uid: string; username: string; email: string; is_admin: boolean; is_approved: boolean; allowed_groups: string[]; created_at: string; updated_at: string };
